...
static int8_t USBTest_Init     (void);
static int8_t USBTest_DeInit   (void);
static int8_t USBTest_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t USBTest_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_USBTest_fops = 
{
  USBTest_Init,
  USBTest_DeInit,
  USBTest_Control,
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t USBTest_Receive(uint8_t* Buf, uint32_t *Len)
{
